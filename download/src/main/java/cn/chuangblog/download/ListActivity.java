...
public class ListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FileAdapter(this, lists, R.layout.item_file);
        ...
        receiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals(ActionConstant.Broadcast.ACTION_UPDATE)) {
                    ...
                    Toast.makeText(ListActivity.this, lists.get(fileInfo.getId()).getFileName() + "下载完成", Toast.LENGTH_SHORT).show();
